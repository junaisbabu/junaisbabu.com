export const whatsApp = (
  <svg
    ...
    viewBox="0 0 50 50"
    className="h-[22px] w-[22px] fill-zinc-500 transition hover:fill-zinc-600 dark:fill-zinc-400 dark:hover:fill-zinc-300"
  >
...
export const skills = (
  <svg
    ...
    stroke-linecap="round"
    stroke-linejoin="round"
    className="h-6 w-6 flex-none stroke-zinc-400 dark:stroke-zinc-500 fill-zinc-100 dark:fill-zinc-100/10"
  >
    ...
    <path
      ...
      className="stroke-zinc-400 dark:stroke-zinc-500 fill-zinc-100/10"
    ></path>
  </svg>
);
...
export const lightSwitch = (
  <svg
    ...
    stroke-linejoin="round"
    aria-hidden="true"
    className="h-6 w-6 fill-zinc-100 stroke-zinc-500 transition hover:fill-zinc-200 hover:stroke-zinc-700 [@media(prefers-color-scheme:dark)]:fill-teal-50 [@media(prefers-color-scheme:dark)]:stroke-teal-500 [@media(prefers-color-scheme:dark)]:hover:fill-teal-50 [@media(prefers-color-scheme:dark)]:hover:stroke-teal-600"
  >
...
export const darkSwitch = (
  <svg
    viewBox="0 0 24 24"
    aria-hidden="true"
    className="h-6 w-6 fill-zinc-700 stroke-zinc-500 transition dark:block [@media(prefers-color-scheme:dark)]:hover:stroke-zinc-400 [@media_not_(prefers-color-scheme:dark)]:fill-teal-400/10 [@media_not_(prefers-color-scheme:dark)]:stroke-teal-500"
  >
    <path
...
export const link = (
  <svg
    ...
    width="16px"
    height="16px"
    className="dark:stroke-indigo-600 stroke-indigo-700 dark:fill-indigo-600 fill-indigo-700"
  >
    ...
    >
      ...
      >
        <path
          ...
          className="flex-none stroke-zinc-400 dark:stroke-zinc-500 fill-zinc-400 dark:fill-zinc-500"
        ></path>
      </g>
    </g>
  </svg>
